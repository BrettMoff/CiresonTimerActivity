...
Write-Host("Working directory: $scriptDir Script Path: $path")
...
#$SMCORE      = [reflection.assembly]::LoadFrom("$scriptDir\dll\Microsoft.EnterpriseManagement.Core.dll") 
#$SMPACKAGING = [reflection.assembly]::LoadFrom("$scriptDir\dll\Microsoft.EnterpriseManagement.Packaging.dll") 
